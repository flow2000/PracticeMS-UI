  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>新增用户的默认密码为：123456</h2>
        <el-image src='http://chuyinweilai.store/apk/qr.png' style="width: 100px; height: 100px"></el-image>
       <!-- <p>
